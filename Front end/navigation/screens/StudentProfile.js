...
function StudentProfile({ navigation }) {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.profileContainer}>
        ...
        <View style={styles.profileTextContainer}>
          ...
          <Text style={styles.username}>@20IT0500</Text>
        </View>
      </View>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.detailItem}>
          <Ionicons style={styles.icon} name="book" />
          <View>
            <Text style={styles.detailLabel}>Your Field</Text>
            <Text style={styles.detailText}>Information Technology</Text>
          </View>
        </View>
      </View>
